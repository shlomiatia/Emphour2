...
const DATA := {
    ...
    "tier_2_weights": {"Crossbowman": 2, "Horse Archer": 1, "Light Cavalry": 1, "Axeman": 1, "Swordman": 1, "Spearman": 1},
    "rewards": {
        ...
        "Act1_Nobility_3": ["new:2:exclude:Crossbowman"],
        "Act1_Nobility_4": ["upgrade:1:2:exclude:Crossbowman"],
        "Act1_Nobility_5": ["upgrade:2:3"],
        "Act1Boss_Peasants_1": ["new:Crossbowman", "upgrade:1:Crossbowman"],
        "Act1Boss_Peasants_2": ["new:Axeman", "upgrade:1:Axeman"],
        "Act1Boss_Nobility_1": ["upgrade:3:4"],
